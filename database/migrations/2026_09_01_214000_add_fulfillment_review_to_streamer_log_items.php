...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('streamer_log_items', function (Blueprint $table) {
            $table->string('fulfillment_status', 32)->nullable()->after('notes');
            ...
            $table->index(['streamer_log_entry_id', 'fulfillment_status'], 'streamer_log_items_fulfillment_idx');
        });
    }
    ...
    {
        Schema::table('streamer_log_items', function (Blueprint $table) {
            $table->dropIndex('streamer_log_items_fulfillment_idx');
