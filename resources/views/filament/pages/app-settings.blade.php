<x-filament-panels::page>
    <div class="space-y-6 max-w-2xl">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {{-- Ollama URL --}}
            <div class="px-6 py-4">
                <label for="ollama_base_url" class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-1.5">
                    Ollama Base URL
                </label>
                <input
                    wire:model.live="ollama_base_url"
                    id="ollama_base_url"
                    type="text"
                ...
                />
                <p class="mt-1 text-xs text-gray-400">Default: http://localhost:11434</p>
            </div>

            {{-- Model --}}
            <div class="px-6 py-4">
                <label for="ollama_model" class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-1.5">
                    Model
                </label>
                <input
                    wire:model.live="ollama_model"
                    id="ollama_model"
                    type="text"
                    placeholder="llama3.2"
                    class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:border-violet-500 focus:ring-2 focus:ring-violet-500 focus:outline-none font-mono"
                />
                <p class="mt-1 text-xs text-gray-400">Any model pulled via <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded font-mono">ollama pull &lt;model&gt;</code></p>
            </div>

            {{-- Timeout --}}
            <div class="px-6 py-4">
                <label for="ollama_timeout" class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-1.5">
                    Request Timeout (seconds)
                </label>
                <input
                    wire:model.live="ollama_timeout"
                    id="ollama_timeout"
                    type="number"
                    min="5"
                    max="300"
                    class="w-48 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:border-violet-500 focus:ring-2 focus:ring-violet-500 focus:outline-none"
                />
                <p class="mt-1 text-xs text-gray-400">Larger models may need 90–120s for first responses</p>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-950 rounded-b-xl">
                ...
                <div class="space-y-1 font-mono text-xs text-gray-500 dark:text-gray-400">
                    <p><span class="text-gray-400">$</span> brew install ollama &nbsp;<span class="text-gray-400"># or see ollama.com</span></p>
