...
<div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-6 py-5">
    ...
    <div class="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div class="rounded-lg bg-green-50 dark:bg-green-950 px-4 py-3 text-center">
            ...
            <p class="text-xs text-green-600 dark:text-green-400 mt-0.5">✅ Auto-Matched</p>
        </div>
        <div class="rounded-lg bg-amber-50 dark:bg-amber-950 px-4 py-3 text-center">
            ...
            <p class="text-xs text-amber-600 dark:text-amber-400 mt-0.5">⚠ Needs Review</p>
        </div>
        <div class="rounded-lg bg-blue-50 dark:bg-blue-950 px-4 py-3 text-center">
            <p class="text-2xl font-bold text-blue-700 dark:text-blue-300">{{ $new }}</p>
            <p class="text-xs text-blue-600 dark:text-blue-400 mt-0.5">🆕 New Products</p>
        </div>
    </div>
...
<div>
    ...
    @if($showManualImport)
    <div class="mt-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 space-y-5">
        ...
        <div class="space-y-2">
            ...
            <input type="file" wire:model="csvFile" accept=".csv,text/csv"
                class="block w-full text-sm text-gray-600 dark:text-gray-300 file:mr-3 file:rounded-lg file:border-0 file:bg-blue-50 dark:file:bg-blue-500/10 file:px-3 file:py-2 file:text-sm file:font-medium file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100" />
...
2025 Bowman Jumbo Hobby | 6 | 130.00"
                class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm font-mono text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </textarea>
...
<div class="rounded-xl border border-green-200 dark:border-green-800 bg-white dark:bg-gray-900 overflow-hidden">
            ...
            <div class="mt-3 space-y-3 border-t border-gray-100 dark:border-gray-800 pt-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <input wire:model="panels.{{ $line['id'] }}.newYear" type="number" placeholder="Year (e.g. 2025)"
                        class="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm font-mono text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" />
    ...
    <div class="rounded-xl border border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-900 overflow-hidden">
        <div class="px-5 py-4">
            <div class="flex items-start gap-3">
                <x-heroicon-o-question-mark-circle class="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <div>
