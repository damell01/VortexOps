<x-filament-widgets::widget>
    ...
    <div class="vx-fc">
        ...
        <div class="flex items-center justify-between gap-3">
            <div><div class="text-sm font-semibold text-gray-950 dark:text-white">Active Show Queue</div><div class="text-xs text-gray-500">Assignment → packing → shipping → count verification → payroll handoff.</div></div>
            ...
            @forelse($queue as $show)
                ...
                <a class="vx-fc-card" href="{{ \App\Filament\Resources\FulfillmentResource::getUrl('view', ['record' => $show]) }}">
                    ...
                    <div class="mt-3 grid grid-cols-3 gap-2 text-center">
                        <div><div class="vx-fc-label">To Pack</div><div class="font-semibold">{{ $stage['pending_lines'] }}</div></div>
