...
class Shows extends Page
{
    ...
    public function showUrl(int $id):string{return ShowResource::getUrl('view',['record'=>$id]);} public function editUrl(int $id):string{return ShowResource::getUrl('edit',['record'=>$id]);} public function shipmentsUrl(int $id):string{return ShipmentResource::getUrl('index',['tableFilters[show_id][value]'=>$id]);}
