<div id="feedback-widget-root"
    ...
    {{-- No trigger of its own. It used to float over the bottom-right corner
         of every page, which put a permanent button on top of table rows,
         modal footers and the last line of every form. It is opened from the
         sidebar now, by the event below — one place in the navigation, where
         somebody looks for it, rather than one place on top of everything. --}}
