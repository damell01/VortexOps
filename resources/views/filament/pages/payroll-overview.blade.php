<x-filament-panels::page>
    ...
    <style>
        ...
        @media(max-width:600px){.vx-card{padding:.85rem;border-radius:.85rem}.vx-kpis{grid-template-columns:1fr 1fr}.vx-actions{display:grid;grid-template-columns:1fr 1fr}.vx-btn{width:100%;min-height:48px}.vx-tools{grid-template-columns:1fr}.vx-ready-grid{grid-template-columns:1fr 1fr}}
    </style>
