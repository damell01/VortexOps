<div id="feedback-widget-root"
    ...
    <button
        ...
        class="vx-feedback-launcher fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-gray-900 dark:bg-gray-800 px-4 py-2.5 text-sm font-semibold text-white shadow-lg ring-1 ring-white/10 hover:bg-gray-800 dark:hover:bg-gray-700 active:scale-95 transition-all duration-150">
