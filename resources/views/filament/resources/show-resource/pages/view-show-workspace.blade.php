        ...
        <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-2">
                    ...
                    @if($analyticsMissing)<span class="vx-chip warn">Whatnot analytics missing</span>@endif
                </div>
            </div>
            <div class="vx-actions-inline">
                ...
                <a class="vx-link" href="{{ \App\Filament\Resources\ShipmentResource::getUrl('index',['show'=>$show->id]) }}">Shipments</a>
            </div>
        </div>
        <div class="vx-kpis">
